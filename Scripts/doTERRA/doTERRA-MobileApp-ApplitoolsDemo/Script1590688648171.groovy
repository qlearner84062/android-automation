...
import com.applitools.eyes.appium.Eyes as Eyes
import com.applitools.eyes.appium.Target as Target
import org.openqa.selenium.By as By
import com.kms.katalon.core.mobile.keyword.internal.MobileDriverFactory as MobileDriverFactory
import io.appium.java_client.AppiumDriver as AppiumDriver
import com.applitools.eyes.FileLogger as FileLogger

Eyes eyes = new Eyes()
eyes.setForceFullPageScreenshot(true)
eyes.setLogHandler(new FileLogger("myLog.txt", true, true))
eyes.setServerUrl("https://eyesapi.applitools.com")
eyes.setApiKey('OlA5Zy3GZbdrMYWRmpsS3gOZgpiAJNhQd100UlA104gZ68E110')

////Launch application
Mobile.startApplication(GlobalVariable.G_AndroidApp, true)
AppiumDriver<?> driver = MobileDriverFactory.getDriver()
eyes.open(driver, 'katalon', 'Test')
...
//String rewardPoints = Mobile.getText(findTestObject('Object Repository/doTERRA-MobileApp/Shop - Page/lbl_700.00'), GlobalVariable.G_Timeout_Long)
